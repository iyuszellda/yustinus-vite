            ...
            <div className="container pt-9">
                <div className="mb-6 flex justify-center space-x-2">
                    ...
                    <Link
                        ...
                        target="_blank"
                        type="button"
                        className="flex md:hidden lg:hidden rounded-full bg-transparent p-3 font-medium uppercase leading-normal text-surface transition duration-150 ease-in-out dark:hover:bg-neutral-700 hover:bg-neutral-300 focus:outline-none focus:ring-0 dark:text-white dark:hover:bg-secondary-900"
                        data-twe-ripple-init
                    >
                        <span className="mx-auto [&>svg]:h-7 [&>svg]:w-7">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 9 71 72"
                                fill="currentColor"
