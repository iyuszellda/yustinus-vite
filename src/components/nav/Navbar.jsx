...
const currentPage = [
    ...
    { name: "Demo", page: "/demo" },
    { name: "Product", page: "/demo/product" },
            ...
            <div className="block sm:hidden">
                ...
                <>
                    <motion.button
                        ...
                        className="sm:block md:hidden lg:hidden text-white fixed bottom-4 left-4 z-50 w-12 h-12 flex items-center justify-center bg-green-400 rounded-full shadow-md transition duration-300"
                    >
                        <svg
