    ...
    return (
        <div className="sticky top-0 z-50 font-sans">
                ...
                <nav className="dark:bg-neutral-700 bg-neutral-100 py-2 dark:border-b-1 dark:border-neutral-600 shadow-md p-4 sm:hidden">
                    <div className="flex justify-between items-center">
                        ...
                        <motion.button
                            ...
                            className="md:block lg:block rounded-full right-15 absolute bg-transparent p-3 font-medium uppercase leading-normal text-surface transition duration-200 ease-in-out dark:hover:bg-neutral-700 hover:bg-neutral-300 focus:outline-none focus:ring-0 dark:text-white dark:hover:bg-secondary-900"
                        >
                            <svg
            ...
            <div className="hidden sm:block xs:block">
                <nav className="dark:bg-neutral-700 bg-neutral-100 py-2 dark:border-b-1 dark:border-neutral-600 shadow-md">
                    <Case>
